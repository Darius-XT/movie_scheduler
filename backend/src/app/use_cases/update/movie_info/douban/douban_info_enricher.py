...
from app.use_cases.update.movie_info.douban.douban_api_client import DoubanApiClient, douban_api_client
from app.use_cases.update.movie_info.douban.models import DoubanMovieSearchItem, DoubanMovieSupplement
...
class DoubanInfoEnricher:
    ...
    def fetch_movie_supplement(self, movie: SupportsDoubanMatchingMovie) -> DoubanMovieSupplement:
        ...
        if not title:
            return DoubanMovieSupplement(score="暂无评分", douban_url=None)
        ...
        return DoubanMovieSupplement(
            score=best_candidate.rating or "暂无评分",
