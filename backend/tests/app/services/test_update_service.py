...
from app.services.update.movie.douban.enricher import DoubanInfoEnricher, SupportsDoubanMatchingMovie
from app.services.update.movie.douban.entities import DoubanMovieSupplement
from app.services.update.service import UpdateService, update_service
